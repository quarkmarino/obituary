...
class CemeteriesControllerTest extends TestCase {

  protected $mockClass = 'Repositories\Interfaces\CemeteryInterface';
  ...
  public function testIndexShouldCallFindAllMethod(){
    ...
    $response = $this->get(route('admin.cemeteries.index'));

    $this->assertResponseOk();
    $this->assertViewHas('cemeteries');
  }
  ...
  public function testCreateShouldCallInstanceMethod(){
    ...
    $response = $this->get(route('admin.cemeteries.create'));

    $this->assertResponseOk();
    $this->assertViewHas('cemetery');
  }
  ...
  public function testStoreShouldCallStoreMethodAndFail(){
    ...
    $response = $this->post(route('admin.cemeteries.store'), ['name' => '', 'location' => '']);
    ...
    $this->assertRedirectedToRoute('admin.cemeteries.create');
     ...
     */
    /*try{
      $response = $this->post(route('admin.cemeteries.store'), ['title' => '', 'author_name' => '']);
    }
  ...
  public function testStoreShouldCallStoreMethodAndSuccess(){
    ...
    $response = $this->post(route('admin.cemeteries.store'), ['name' => 'Foo Name', 'location' => 'Bar Location']);
     ...
     */
    $this->assertResponseStatus(302);
    $this->assertRedirectedToRoute('admin.cemeteries.index');
  ...
  public function testShowShouldCallFindByIdMethodAndFail(){
    ...
    $response = $this->get(route('admin.cemeteries.show', [2]));
  ...
  public function testShowShouldCallFindByIdMethodAndSuccess(){
    ...
    $response = $this->get(route('admin.cemeteries.show', [1]));
  ...
  public function testEditShouldCallFindByIdMethod(){
    ...
    $response = $this->get(route('admin.cemeteries.edit', [1]));
  ...
  public function testUpdateShouldCallUpdateMethod(){
    ...
    $response = $this->put(route('admin.cemeteries.update', 1), $input);
     ...
     */
    $this->assertResponseStatus(302);
    $this->assertRedirectedToRoute('admin.cemeteries.show', 1);
  ...
  public function testDestroyShouldCallDestroyMethod(){
    ...
    $response = $this->delete( route('admin.cemeteries.destroy', array(1)));
